...
@section('content')
    <div class="container mt-5">
        <h1 class="mb-4">List of Homeowner</h1>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ route('homeowner.delete', $homeowner->id) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this homeowner?');">Delete</button>
                                </form>
                                <!-- Vehicles Button -->
